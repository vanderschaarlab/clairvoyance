...
if __name__ == "__main__":
    ...
    parser.add_argument("--active_sensing_model_name", choices=["asac", "deepsensing"], default="asac", type=str)
    parser.add_argument("--model_name", choices=["rnn", "lstm", "gru"], default="gru", type=str)
